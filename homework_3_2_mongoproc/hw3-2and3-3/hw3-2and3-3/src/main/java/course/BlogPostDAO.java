...
public class BlogPostDAO {
    ...
    public DBObject findByPermalink(String permalink) {
        ...
        post = postsCollection.find(new BasicDBObject("permalink", permalink)).next();
   ...
   // White space to protect the innocent
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        DBObject post = postsCollection.find(new BasicDBObject("permalink", permalink)).next();

        HashMap<String, Object> comments = new HashMap<String, Object>();

        comments.put("author", name);
        comments.put("body", body);
        if (email != null) {
            comments.put("email", email);
        }
        
        ArrayList<HashMap<String, Object>> postComments = (ArrayList<HashMap<String, Object>>)post.get("comments");
        ...
        post.put("comments", postComments);
